...
public class SnowyGlowingOakForestBiome {
	public static final Climate.ParameterPoint PARAMETER_POINT = new Climate.ParameterPoint(
			Climate.Parameter.span(-0.485714285714f, -0.314285714286f), Climate.Parameter.span(-0.485714285714f, -0.314285714286f),
			Climate.Parameter.span(0.484285714286f, 0.655714285714f), Climate.Parameter.span(0.514285714286f, 0.685714285714f),
			Climate.Parameter.point(0), Climate.Parameter.span(0.901422840344f, 1.072851411772f), 0);
	...
	public static Biome createBiome() {
		...
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION,
				PlacementUtils.register("ragemod:grass_snowy_glowing_oak_forest", VegetationFeatures.PATCH_GRASS,
		...
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, PlacementUtils
				.register("ragemod:seagrass_snowy_glowing_oak_forest", AquaticFeatures.SEAGRASS_SHORT, AquaticPlacements.seagrassPlacement(1)));
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION,
				PlacementUtils.register("ragemod:flower_snowy_glowing_oak_forest", VegetationFeatures.FLOWER_DEFAULT, List.of(CountPlacement.of(11),
						RarityFilter.onAverageOnceEvery(32), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome())));
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION,
				PlacementUtils.register("ragemod:mushrooms_huge_snowy_glowing_oak_forest", VegetationFeatures.MUSHROOM_ISLAND_VEGETATION,
						List.of(CountPlacement.of(1), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome())));
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION,
				PlacementUtils.register("ragemod:disk_gravel_snowy_glowing_oak_forest",
						FeatureUtils.register("ragemod:disk_gravel_snowy_glowing_oak_forest", Feature.DISK,
		...
		return new Biome.BiomeBuilder().precipitation(Biome.Precipitation.SNOW).biomeCategory(Biome.BiomeCategory.FOREST).temperature(-0.1f)
	...
	public static void init() {
		BiomeDictionary.addTypes(
				ResourceKey.create(Registry.BIOME_REGISTRY, BuiltinRegistries.BIOME.getKey(RagemodModBiomes.SNOWY_GLOWING_OAK_FOREST.get())),
