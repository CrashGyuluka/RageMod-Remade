...
public class SpareGlowingOakTree2Feature extends Feature<NoneFeatureConfiguration> {
	public static final SpareGlowingOakTree2Feature FEATURE = (SpareGlowingOakTree2Feature) new SpareGlowingOakTree2Feature()
			.setRegistryName("ragemod:spare_glowing_oak_tree_2");
