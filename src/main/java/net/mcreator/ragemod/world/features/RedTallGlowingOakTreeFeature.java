...
public class RedTallGlowingOakTreeFeature extends Feature<NoneFeatureConfiguration> {
	public static RedTallGlowingOakTreeFeature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new RedTallGlowingOakTreeFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("ragemod:red_tall_glowing_oak_tree", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("ragemod:red_tall_glowing_oak_tree", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public RedTallGlowingOakTreeFeature() {
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		if (!generate_dimensions.contains(context.level().getLevel().dimension()))
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("ragemod", "tall_red_glowing_oak_tree"));
		if (template == null)
			return false;
