...
public class GlowingBiomeFerne1Feature extends Feature<NoneFeatureConfiguration> {
	public static GlowingBiomeFerne1Feature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new GlowingBiomeFerne1Feature();
		CONFIGURED_FEATURE = FeatureUtils.register("ragemod:glowing_biome_ferne_1", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("ragemod:glowing_biome_ferne_1", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public GlowingBiomeFerne1Feature() {
