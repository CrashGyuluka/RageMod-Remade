...
public class GlowingOakTreeDense3Feature extends Feature<NoneFeatureConfiguration> {
	public static GlowingOakTreeDense3Feature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new GlowingOakTreeDense3Feature();
		CONFIGURED_FEATURE = FeatureUtils.register("ragemod:glowing_oak_tree_dense_3", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("ragemod:glowing_oak_tree_dense_3", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public GlowingOakTreeDense3Feature() {
