...
public class GlowingOakFoliageDense3Feature extends Feature<NoneFeatureConfiguration> {
	public static GlowingOakFoliageDense3Feature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new GlowingOakFoliageDense3Feature();
		CONFIGURED_FEATURE = FeatureUtils.register("ragemod:glowing_oak_foliage_dense_3", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("ragemod:glowing_oak_foliage_dense_3", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public GlowingOakFoliageDense3Feature() {
