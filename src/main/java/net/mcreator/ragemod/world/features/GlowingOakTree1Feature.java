...
public class GlowingOakTree1Feature extends Feature<NoneFeatureConfiguration> {
	public static GlowingOakTree1Feature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new GlowingOakTree1Feature();
		CONFIGURED_FEATURE = FeatureUtils.register("ragemod:glowing_oak_tree_1", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("ragemod:glowing_oak_tree_1", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public static final Set<ResourceLocation> GENERATE_BIOMES = Set.of(new ResourceLocation("ragemod:glowing_oak_forest"),
			new ResourceLocation("ragemod:glowing_oak_forest_mountain"), new ResourceLocation("ragemod:snowy_glowing_oak_forest"));
