...
public class GlowingBiomeLargefrene1Feature extends Feature<NoneFeatureConfiguration> {
	public static GlowingBiomeLargefrene1Feature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new GlowingBiomeLargefrene1Feature();
		CONFIGURED_FEATURE = FeatureUtils.register("ragemod:glowing_biome_largefrene_1", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("ragemod:glowing_biome_largefrene_1", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public GlowingBiomeLargefrene1Feature() {
