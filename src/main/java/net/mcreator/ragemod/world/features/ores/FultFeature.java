...
public class FultFeature extends OreFeature {
	...
	public static Feature<?> feature() {
		...
		PLACED_FEATURE = PlacementUtils.register("ragemod:fult", CONFIGURED_FEATURE,
				List.of(CountPlacement.of(5), HeightRangePlacement.uniform(VerticalAnchor.absolute(0), VerticalAnchor.absolute(80))));
		return FEATURE;
	}
