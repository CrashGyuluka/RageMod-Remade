...
public class GlowingOakFieldTree5Feature extends Feature<NoneFeatureConfiguration> {
	public static final GlowingOakFieldTree5Feature FEATURE = (GlowingOakFieldTree5Feature) new GlowingOakFieldTree5Feature()
			.setRegistryName("ragemod:glowing_oak_field_tree_5");
