...
public class GlowingOakTree2Feature extends Feature<NoneFeatureConfiguration> {
	public static GlowingOakTree2Feature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new GlowingOakTree2Feature();
		CONFIGURED_FEATURE = FeatureUtils.register("ragemod:glowing_oak_tree_2", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("ragemod:glowing_oak_tree_2", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
