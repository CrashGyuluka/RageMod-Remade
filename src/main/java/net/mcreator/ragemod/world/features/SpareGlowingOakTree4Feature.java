...
public class SpareGlowingOakTree4Feature extends Feature<NoneFeatureConfiguration> {
	public static final SpareGlowingOakTree4Feature FEATURE = (SpareGlowingOakTree4Feature) new SpareGlowingOakTree4Feature()
			.setRegistryName("ragemod:spare_glowing_oak_tree_4");
