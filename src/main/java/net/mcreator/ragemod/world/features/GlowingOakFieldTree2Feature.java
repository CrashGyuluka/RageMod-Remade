...
public class GlowingOakFieldTree2Feature extends Feature<NoneFeatureConfiguration> {
	public static final GlowingOakFieldTree2Feature FEATURE = (GlowingOakFieldTree2Feature) new GlowingOakFieldTree2Feature()
			.setRegistryName("ragemod:glowing_oak_field_tree_2");
