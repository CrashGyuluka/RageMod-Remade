...
public class GlowingBiomesFlower2Feature extends Feature<NoneFeatureConfiguration> {
	public static final GlowingBiomesFlower2Feature FEATURE = (GlowingBiomesFlower2Feature) new GlowingBiomesFlower2Feature()
			.setRegistryName("ragemod:glowing_biomes_flower_2");
