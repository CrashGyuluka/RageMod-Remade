...
public class GlowingOakFieldTree4Feature extends Feature<NoneFeatureConfiguration> {
	public static final GlowingOakFieldTree4Feature FEATURE = (GlowingOakFieldTree4Feature) new GlowingOakFieldTree4Feature()
			.setRegistryName("ragemod:glowing_oak_field_tree_4");
