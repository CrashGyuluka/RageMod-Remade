...
public class AnapaitOreFeature extends OreFeature {
	public static final AnapaitOreFeature FEATURE = (AnapaitOreFeature) new AnapaitOreFeature().setRegistryName("ragemod:anapait_ore");
	public static final ConfiguredFeature<?, ?> CONFIGURED_FEATURE = FEATURE
			.configured(new OreConfiguration(AnapaitOreFeatureRuleTest.INSTANCE, RagemodModBlocks.ANAPAIT_ORE.defaultBlockState(), 4))
	...
	private static class AnapaitOreFeatureRuleTest extends RuleTest {
		...
		static final RuleTestType<AnapaitOreFeatureRuleTest> CUSTOM_MATCH = Registry.register(Registry.RULE_TEST,
				new ResourceLocation("ragemod:anapait_ore_match"), () -> codec);
