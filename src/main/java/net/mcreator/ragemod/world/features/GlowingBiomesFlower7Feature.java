...
public class GlowingBiomesFlower7Feature extends Feature<NoneFeatureConfiguration> {
	public static final GlowingBiomesFlower7Feature FEATURE = (GlowingBiomesFlower7Feature) new GlowingBiomesFlower7Feature()
			.setRegistryName("ragemod:glowing_biomes_flower_7");
