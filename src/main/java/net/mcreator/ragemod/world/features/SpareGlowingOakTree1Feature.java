...
public class SpareGlowingOakTree1Feature extends Feature<NoneFeatureConfiguration> {
	public static final SpareGlowingOakTree1Feature FEATURE = (SpareGlowingOakTree1Feature) new SpareGlowingOakTree1Feature()
			.setRegistryName("ragemod:spare_glowing_oak_tree_1");
