...
public class CerussiteOreFeature extends OreFeature {
	...
	public static Feature<?> feature() {
		...
		PLACED_FEATURE = PlacementUtils.register("ragemod:cerussite_ore", CONFIGURED_FEATURE,
				List.of(CountPlacement.of(8), HeightRangePlacement.uniform(VerticalAnchor.absolute(50), VerticalAnchor.absolute(128))));
		return FEATURE;
	}
