...
public class GlowingBiomesFlower3Feature extends Feature<NoneFeatureConfiguration> {
	public static final GlowingBiomesFlower3Feature FEATURE = (GlowingBiomesFlower3Feature) new GlowingBiomesFlower3Feature()
			.setRegistryName("ragemod:glowing_biomes_flower_3");
