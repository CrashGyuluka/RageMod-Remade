...
public class GlowingOakFoliageDense4Feature extends Feature<NoneFeatureConfiguration> {
	public static GlowingOakFoliageDense4Feature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new GlowingOakFoliageDense4Feature();
		CONFIGURED_FEATURE = FeatureUtils.register("ragemod:glowing_oak_foliage_dense_4", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("ragemod:glowing_oak_foliage_dense_4", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public GlowingOakFoliageDense4Feature() {
