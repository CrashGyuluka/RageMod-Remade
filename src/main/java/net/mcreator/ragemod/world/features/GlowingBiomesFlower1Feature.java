...
public class GlowingBiomesFlower1Feature extends Feature<NoneFeatureConfiguration> {
	public static final GlowingBiomesFlower1Feature FEATURE = (GlowingBiomesFlower1Feature) new GlowingBiomesFlower1Feature()
			.setRegistryName("ragemod:glowing_biomes_flower_1");
