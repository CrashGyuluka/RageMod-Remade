...
public class SpareGlowingOakTree5Feature extends Feature<NoneFeatureConfiguration> {
	public static final SpareGlowingOakTree5Feature FEATURE = (SpareGlowingOakTree5Feature) new SpareGlowingOakTree5Feature()
			.setRegistryName("ragemod:spare_glowing_oak_tree_5");
