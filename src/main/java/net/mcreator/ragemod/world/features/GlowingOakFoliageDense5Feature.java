...
public class GlowingOakFoliageDense5Feature extends Feature<NoneFeatureConfiguration> {
	public static GlowingOakFoliageDense5Feature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new GlowingOakFoliageDense5Feature();
		CONFIGURED_FEATURE = FeatureUtils.register("ragemod:glowing_oak_foliage_dense_5", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("ragemod:glowing_oak_foliage_dense_5", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public GlowingOakFoliageDense5Feature() {
