...
public class SpareGlowingOakTree3Feature extends Feature<NoneFeatureConfiguration> {
	public static final SpareGlowingOakTree3Feature FEATURE = (SpareGlowingOakTree3Feature) new SpareGlowingOakTree3Feature()
			.setRegistryName("ragemod:spare_glowing_oak_tree_3");
