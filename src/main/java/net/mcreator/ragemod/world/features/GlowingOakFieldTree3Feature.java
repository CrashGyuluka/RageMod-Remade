...
public class GlowingOakFieldTree3Feature extends Feature<NoneFeatureConfiguration> {
	public static final GlowingOakFieldTree3Feature FEATURE = (GlowingOakFieldTree3Feature) new GlowingOakFieldTree3Feature()
			.setRegistryName("ragemod:glowing_oak_field_tree_3");
