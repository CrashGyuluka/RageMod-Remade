...
public class GlowingBiomesBush3Feature extends Feature<NoneFeatureConfiguration> {
	public static GlowingBiomesBush3Feature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new GlowingBiomesBush3Feature();
		CONFIGURED_FEATURE = FeatureUtils.register("ragemod:glowing_biomes_bush_3", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("ragemod:glowing_biomes_bush_3", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public GlowingBiomesBush3Feature() {
