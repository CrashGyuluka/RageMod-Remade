...
public class GlowingBiomesBush3Feature extends Feature<NoneFeatureConfiguration> {
	public static final GlowingBiomesBush3Feature FEATURE = (GlowingBiomesBush3Feature) new GlowingBiomesBush3Feature()
			.setRegistryName("ragemod:glowing_biomes_bush_3");
