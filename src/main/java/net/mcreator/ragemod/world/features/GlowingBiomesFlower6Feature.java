...
public class GlowingBiomesFlower6Feature extends Feature<NoneFeatureConfiguration> {
	public static final GlowingBiomesFlower6Feature FEATURE = (GlowingBiomesFlower6Feature) new GlowingBiomesFlower6Feature()
			.setRegistryName("ragemod:glowing_biomes_flower_6");
