...
public class GlowingBiomesFlower5Feature extends Feature<NoneFeatureConfiguration> {
	public static final GlowingBiomesFlower5Feature FEATURE = (GlowingBiomesFlower5Feature) new GlowingBiomesFlower5Feature()
			.setRegistryName("ragemod:glowing_biomes_flower_5");
