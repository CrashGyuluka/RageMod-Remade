...
public class GlowingBiomesFlower8Feature extends Feature<NoneFeatureConfiguration> {
	public static final GlowingBiomesFlower8Feature FEATURE = (GlowingBiomesFlower8Feature) new GlowingBiomesFlower8Feature()
			.setRegistryName("ragemod:glowing_biomes_flower_8");
