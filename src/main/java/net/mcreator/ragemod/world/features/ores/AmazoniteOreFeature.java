...
public class AmazoniteOreFeature extends OreFeature {
	...
	public static Feature<?> feature() {
		...
		PLACED_FEATURE = PlacementUtils.register("ragemod:amazonite_ore", CONFIGURED_FEATURE,
				List.of(CountPlacement.of(9), HeightRangePlacement.uniform(VerticalAnchor.absolute(30), VerticalAnchor.absolute(128))));
		return FEATURE;
	}
