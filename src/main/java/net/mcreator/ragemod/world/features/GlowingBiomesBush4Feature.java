...
public class GlowingBiomesBush4Feature extends Feature<NoneFeatureConfiguration> {
	public static GlowingBiomesBush4Feature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new GlowingBiomesBush4Feature();
		CONFIGURED_FEATURE = FeatureUtils.register("ragemod:glowing_biomes_bush_4", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("ragemod:glowing_biomes_bush_4", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public GlowingBiomesBush4Feature() {
