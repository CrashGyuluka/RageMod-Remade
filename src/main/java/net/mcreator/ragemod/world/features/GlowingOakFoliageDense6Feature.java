...
public class GlowingOakFoliageDense6Feature extends Feature<NoneFeatureConfiguration> {
	public static GlowingOakFoliageDense6Feature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new GlowingOakFoliageDense6Feature();
		CONFIGURED_FEATURE = FeatureUtils.register("ragemod:glowing_oak_foliage_dense_6", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("ragemod:glowing_oak_foliage_dense_6", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public GlowingOakFoliageDense6Feature() {
