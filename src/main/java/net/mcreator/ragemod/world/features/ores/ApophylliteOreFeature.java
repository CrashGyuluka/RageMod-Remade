...
public class ApophylliteOreFeature extends OreFeature {
	...
	public static Feature<?> feature() {
		...
		PLACED_FEATURE = PlacementUtils.register("ragemod:apophyllite_ore", CONFIGURED_FEATURE,
				List.of(CountPlacement.of(8), HeightRangePlacement.uniform(VerticalAnchor.absolute(0), VerticalAnchor.absolute(128))));
		return FEATURE;
	}
