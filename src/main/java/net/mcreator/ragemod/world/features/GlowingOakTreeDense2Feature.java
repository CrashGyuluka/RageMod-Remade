...
public class GlowingOakTreeDense2Feature extends Feature<NoneFeatureConfiguration> {
	public static GlowingOakTreeDense2Feature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new GlowingOakTreeDense2Feature();
		CONFIGURED_FEATURE = FeatureUtils.register("ragemod:glowing_oak_tree_dense_2", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("ragemod:glowing_oak_tree_dense_2", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public GlowingOakTreeDense2Feature() {
