...
public class CaltenFeature extends OreFeature {
	...
	public static Feature<?> feature() {
		...
		PLACED_FEATURE = PlacementUtils.register("ragemod:calten", CONFIGURED_FEATURE,
				List.of(CountPlacement.of(12), HeightRangePlacement.uniform(VerticalAnchor.absolute(0), VerticalAnchor.absolute(256))));
		return FEATURE;
	}
