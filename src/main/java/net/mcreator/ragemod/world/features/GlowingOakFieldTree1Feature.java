...
public class GlowingOakFieldTree1Feature extends Feature<NoneFeatureConfiguration> {
	public static final GlowingOakFieldTree1Feature FEATURE = (GlowingOakFieldTree1Feature) new GlowingOakFieldTree1Feature()
			.setRegistryName("ragemod:glowing_oak_field_tree_1");
