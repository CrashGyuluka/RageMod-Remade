...
public class GlowingOakFieldTree1Feature extends Feature<NoneFeatureConfiguration> {
	public static GlowingOakFieldTree1Feature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new GlowingOakFieldTree1Feature();
		CONFIGURED_FEATURE = FeatureUtils.register("ragemod:glowing_oak_field_tree_1", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("ragemod:glowing_oak_field_tree_1", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public GlowingOakFieldTree1Feature() {
