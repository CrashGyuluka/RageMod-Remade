...
public class GlowingBiomesBush1Feature extends Feature<NoneFeatureConfiguration> {
	public static GlowingBiomesBush1Feature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new GlowingBiomesBush1Feature();
		CONFIGURED_FEATURE = FeatureUtils.register("ragemod:glowing_biomes_bush_1", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("ragemod:glowing_biomes_bush_1", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public GlowingBiomesBush1Feature() {
