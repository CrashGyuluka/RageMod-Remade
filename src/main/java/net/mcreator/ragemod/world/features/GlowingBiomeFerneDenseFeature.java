...
public class GlowingBiomeFerneDenseFeature extends Feature<NoneFeatureConfiguration> {
	public static GlowingBiomeFerneDenseFeature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new GlowingBiomeFerneDenseFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("ragemod:glowing_biome_ferne_dense", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("ragemod:glowing_biome_ferne_dense", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public GlowingBiomeFerneDenseFeature() {
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		if (!generate_dimensions.contains(context.level().getLevel().dimension()))
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("ragemod", "glowingbiome_fern"));
		if (template == null)
			return false;
