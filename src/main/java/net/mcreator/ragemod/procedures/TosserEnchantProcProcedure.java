	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				RagemodMod.LOGGER.warn("Failed to load dependency entity for procedure TosserEnchantProc!");
			return;
		}
		Entity entity = (Entity) dependencies.get("entity");
		double enchantLevel = 0;
		enchantLevel = (EnchantmentHelper.getEnchantmentLevel(TosserEnchantmentEnchantment.enchantment,
				((entity instanceof LivingEntity) ? ((LivingEntity) entity).getItemStackFromSlot(EquipmentSlotType.CHEST) : ItemStack.EMPTY)));
		if (enchantLevel > 0) {
			entity.setMotion(0, (2 + enchantLevel), 0);
		}
	}
}
