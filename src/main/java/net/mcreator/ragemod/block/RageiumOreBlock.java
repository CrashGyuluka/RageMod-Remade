...
public class RageiumOreBlock extends RagemodModElements.ModElement {
	@ObjectHolder("ragemod:rageium_ore")
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("ragemod:rageium_ore_match"), () -> CustomRuleTest.codec);
			...
			configuredFeature = feature.withConfiguration(new OreFeatureConfig(CustomRuleTest.INSTANCE, block.getDefaultState(), 5)).range(120)
					.square().func_242731_b(9);
			event.getRegistry().register(feature.setRegistryName("rageium_ore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("ragemod:rageium_ore"), configuredFeature);
		}
	}
