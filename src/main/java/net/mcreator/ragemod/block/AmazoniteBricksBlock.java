...
public class AmazoniteBricksBlock extends RagemodModElements.ModElement {
	@ObjectHolder("ragemod:amazonite_bricks")
	public static final Block block = null;

	public AmazoniteBricksBlock(RagemodModElements instance) {
		super(instance, 60);
	}
