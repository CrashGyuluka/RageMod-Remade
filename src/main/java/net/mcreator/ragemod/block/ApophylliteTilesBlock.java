...
public class ApophylliteTilesBlock extends RagemodModElements.ModElement {
	@ObjectHolder("ragemod:apophyllite_tiles")
	public static final Block block = null;

	public ApophylliteTilesBlock(RagemodModElements instance) {
		super(instance, 65);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("apophyllite_tiles");
		}
