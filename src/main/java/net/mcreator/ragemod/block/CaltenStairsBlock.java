...
public class CaltenStairsBlock extends RagemodModElements.ModElement {
	@ObjectHolder("ragemod:calten_stairs")
	public static final Block block = null;

	public CaltenStairsBlock(RagemodModElements instance) {
		super(instance, 34);
	}
