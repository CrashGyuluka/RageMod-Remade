...
public class FultBricksBlock extends RagemodModElements.ModElement {
	@ObjectHolder("ragemod:fult_bricks")
	public static final Block block = null;

	public FultBricksBlock(RagemodModElements instance) {
		super(instance, 302);
	}
