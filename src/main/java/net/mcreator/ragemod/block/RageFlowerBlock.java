...
public class RageFlowerBlock extends RagemodModElements.ModElement {
	@ObjectHolder("ragemod:rage_flower")
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("rage_flower"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("ragemod:rage_flower"), configuredFeature);
		}
	}
