...
public class CerussiteBricksBlock extends RagemodModElements.ModElement {
	@ObjectHolder("ragemod:cerussite_bricks")
	public static final Block block = null;

	public CerussiteBricksBlock(RagemodModElements instance) {
		super(instance, 67);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cerussite_bricks");
		}
