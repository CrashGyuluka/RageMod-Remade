...
public class AmazoniteBrickWallBlock extends RagemodModElements.ModElement {
	@ObjectHolder("ragemod:amazonite_brick_wall")
	public static final Block block = null;

	public AmazoniteBrickWallBlock(RagemodModElements instance) {
		super(instance, 61);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("amazonite_brick_wall");
		}
