...
public class ApophylliteTileWallBlock extends RagemodModElements.ModElement {
	@ObjectHolder("ragemod:apophyllite_tile_wall")
	public static final Block block = null;

	public ApophylliteTileWallBlock(RagemodModElements instance) {
		super(instance, 68);
	}
