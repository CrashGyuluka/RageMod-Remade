...
public class CerussiteBrickStairsBlock extends RagemodModElements.ModElement {
	@ObjectHolder("ragemod:cerussite_brick_stairs")
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			super(() -> new Block(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2f, 10f).setLightLevel(s -> 0)
					...
					.setEmmisiveRendering((bs, br, bp) -> true)).getDefaultState(),
			...
			setRegistryName("cerussite_brick_stairs");
		}
