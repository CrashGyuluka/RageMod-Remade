...
public class CerussiteBrickSlabBlock extends RagemodModElements.ModElement {
	@ObjectHolder("ragemod:cerussite_brick_slab")
	public static final Block block = null;

	public CerussiteBrickSlabBlock(RagemodModElements instance) {
		super(instance, 71);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("cerussite_brick_slab");
		}
