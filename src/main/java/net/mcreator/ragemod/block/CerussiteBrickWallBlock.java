...
public class CerussiteBrickWallBlock extends RagemodModElements.ModElement {
	@ObjectHolder("ragemod:cerussite_brick_wall")
	public static final Block block = null;

	public CerussiteBrickWallBlock(RagemodModElements instance) {
		super(instance, 70);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("cerussite_brick_wall");
		}
