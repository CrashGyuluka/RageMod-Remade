...
public class CaltenBricksStairsBlock extends RagemodModElements.ModElement {
	@ObjectHolder("ragemod:calten_bricks_stairs")
	public static final Block block = null;

	public CaltenBricksStairsBlock(RagemodModElements instance) {
		super(instance, 43);
	}
