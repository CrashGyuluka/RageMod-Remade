...
public class CaltenBricksWallBlock extends RagemodModElements.ModElement {
	@ObjectHolder("ragemod:calten_bricks_wall")
	public static final Block block = null;

	public CaltenBricksWallBlock(RagemodModElements instance) {
		super(instance, 47);
	}
