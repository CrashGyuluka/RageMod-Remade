...
public class RageiumBrickPressurePlateBlock extends RagemodModElements.ModElement {
	@ObjectHolder("ragemod:rageium_brick_pressure_plate")
	public static final Block block = null;

	public RageiumBrickPressurePlateBlock(RagemodModElements instance) {
		super(instance, 11);
	}
	...
	public static class CustomBlock extends PressurePlateBlock {
		public CustomBlock() {
			super(Sensitivity.MOBS, Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2f, 15f).setLightLevel(s -> 0)
