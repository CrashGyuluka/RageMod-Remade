...
public class GreenGlowingOakTreeSaplingBlock extends RagemodModElements.ModElement {
	@ObjectHolder("ragemod:green_glowing_oak_tree_sapling")
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("green_glowing_oak_tree_sapling"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("ragemod:green_glowing_oak_tree_sapling"),
					configuredFeature);
		}
	}
