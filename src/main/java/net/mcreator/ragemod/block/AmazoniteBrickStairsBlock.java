...
public class AmazoniteBrickStairsBlock extends RagemodModElements.ModElement {
	@ObjectHolder("ragemod:amazonite_brick_stairs")
	public static final Block block = null;

	public AmazoniteBrickStairsBlock(RagemodModElements instance) {
		super(instance, 59);
	}
