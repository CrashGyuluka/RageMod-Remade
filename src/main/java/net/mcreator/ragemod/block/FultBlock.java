...
public class FultBlock extends RagemodModElements.ModElement {
	@ObjectHolder("ragemod:fult")
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("ragemod:fult_match"), () -> CustomRuleTest.codec);
