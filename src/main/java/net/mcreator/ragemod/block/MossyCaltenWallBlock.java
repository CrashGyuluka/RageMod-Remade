...
public class MossyCaltenWallBlock extends RagemodModElements.ModElement {
	@ObjectHolder("ragemod:mossy_calten_wall")
	public static final Block block = null;

	public MossyCaltenWallBlock(RagemodModElements instance) {
		super(instance, 41);
	}
