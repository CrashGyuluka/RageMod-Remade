...
public class SmoothCaltenWallBlock extends RagemodModElements.ModElement {
	@ObjectHolder("ragemod:smooth_calten_wall")
	public static final Block block = null;

	public SmoothCaltenWallBlock(RagemodModElements instance) {
		super(instance, 42);
	}
