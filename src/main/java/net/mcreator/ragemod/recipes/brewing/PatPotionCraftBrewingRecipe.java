...
public class PatPotionCraftBrewingRecipe implements IBrewingRecipe {
	...
	public boolean isInput(ItemStack input) {
		return input.getItem() == RagemodModItems.RAGE_POTION;
	}

	@Override
	public boolean isIngredient(ItemStack ingredient) {
		return ingredient.getItem() == RagemodModItems.TOXIC_CRYSTAL;
	}

	@Override
	public ItemStack getOutput(ItemStack input, ItemStack ingredient) {
		if (isInput(input) && isIngredient(ingredient)) {
			return new ItemStack(RagemodModItems.PAT_POTION);
		}
