...
import net.mcreator.ragemod.block.CerussiteBricksBlock;
import net.mcreator.ragemod.block.CerussiteBrickWallBlock;
import net.mcreator.ragemod.block.CerussiteBrickStairsBlock;
import net.mcreator.ragemod.block.CerussiteBrickSlabBlock;
...
import net.mcreator.ragemod.block.BlockOfFultBlock;
import net.mcreator.ragemod.block.BlockOfApophylliteBlock;
import net.mcreator.ragemod.block.AzuriteOreBlock;
import net.mcreator.ragemod.block.AzuritBlockBlock;
import net.mcreator.ragemod.block.ApophylliteTilesBlock;
import net.mcreator.ragemod.block.ApophylliteTileWallBlock;
import net.mcreator.ragemod.block.ApophylliteTileStairsBlock;
import net.mcreator.ragemod.block.ApophylliteTileSlabBlock;
...
public class RagemodModBlocks {
	...
	public static final RegistryObject<Block> FULT_BRICKS = REGISTRY.register("fult_bricks", () -> new FultBricksBlock());
	public static final RegistryObject<Block> BLOCK_OF_FULT = REGISTRY.register("block_of_fult", () -> new BlockOfFultBlock());
	...
	public static final RegistryObject<Block> AZURIT_BLOCK = REGISTRY.register("azurit_block", () -> new AzuritBlockBlock());
	...
	public static final RegistryObject<Block> CERUSSITE_BRICKS = REGISTRY.register("cerussite_bricks", () -> new CerussiteBricksBlock());
	public static final RegistryObject<Block> CERUSSITE_BRICK_STAIRS = REGISTRY.register("cerussite_brick_stairs",
			() -> new CerussiteBrickStairsBlock());
	public static final RegistryObject<Block> CERUSSITE_BRICK_SLAB = REGISTRY.register("cerussite_brick_slab", () -> new CerussiteBrickSlabBlock());
	public static final RegistryObject<Block> CERUSSITE_BRICK_WALL = REGISTRY.register("cerussite_brick_wall", () -> new CerussiteBrickWallBlock());
	public static final RegistryObject<Block> BLOCK_OF_APOPHYLLITE = REGISTRY.register("block_of_apophyllite", () -> new BlockOfApophylliteBlock());
	public static final RegistryObject<Block> APOPHYLLITE_TILES = REGISTRY.register("apophyllite_tiles", () -> new ApophylliteTilesBlock());
	public static final RegistryObject<Block> APOPHYLLITE_TILE_STAIRS = REGISTRY.register("apophyllite_tile_stairs",
			() -> new ApophylliteTileStairsBlock());
	public static final RegistryObject<Block> APOPHYLLITE_TILE_SLAB = REGISTRY.register("apophyllite_tile_slab",
			() -> new ApophylliteTileSlabBlock());
	public static final RegistryObject<Block> APOPHYLLITE_TILE_WALL = REGISTRY.register("apophyllite_tile_wall",
			() -> new ApophylliteTileWallBlock());
	...
	public static class ClientSideHandler {
		...
		public static void clientSetup(FMLClientSetupEvent event) {
			...
			CerussiteBrickStairsBlock.registerRenderLayer();
			CerussiteBrickSlabBlock.registerRenderLayer();
			CerussiteBrickWallBlock.registerRenderLayer();
			ApophylliteTileStairsBlock.registerRenderLayer();
			ApophylliteTileSlabBlock.registerRenderLayer();
			ApophylliteTileWallBlock.registerRenderLayer();
		}
	}
}
