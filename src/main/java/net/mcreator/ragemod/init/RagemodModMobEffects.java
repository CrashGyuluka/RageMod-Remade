...
import net.mcreator.ragemod.potion.ProtectionAgainstToxicMobEffect;
...
public class RagemodModMobEffects {
	...
	public static final MobEffect PROTECTION_AGAINST_TOXIC = register(new ProtectionAgainstToxicMobEffect());
