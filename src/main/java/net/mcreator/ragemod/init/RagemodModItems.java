...
public class RagemodModItems {
	...
	public static final RegistryObject<Item> FULT_BRICKS = block(RagemodModBlocks.FULT_BRICKS, RagemodModTabs.TAB_RAGEMOD_TAB);
	...
	public static final RegistryObject<Item> AZURIT_BLOCK = block(RagemodModBlocks.AZURIT_BLOCK, RagemodModTabs.TAB_RAGEMOD_TAB);
	...
	public static final RegistryObject<Item> CERUSSITE_BRICKS = block(RagemodModBlocks.CERUSSITE_BRICKS, RagemodModTabs.TAB_RAGEMOD_TAB);
	public static final RegistryObject<Item> CERUSSITE_BRICK_STAIRS = block(RagemodModBlocks.CERUSSITE_BRICK_STAIRS, RagemodModTabs.TAB_RAGEMOD_TAB);
	public static final RegistryObject<Item> CERUSSITE_BRICK_SLAB = block(RagemodModBlocks.CERUSSITE_BRICK_SLAB, RagemodModTabs.TAB_RAGEMOD_TAB);
	public static final RegistryObject<Item> CERUSSITE_BRICK_WALL = block(RagemodModBlocks.CERUSSITE_BRICK_WALL, RagemodModTabs.TAB_RAGEMOD_TAB);
	public static final RegistryObject<Item> BLOCK_OF_APOPHYLLITE = block(RagemodModBlocks.BLOCK_OF_APOPHYLLITE, RagemodModTabs.TAB_RAGEMOD_TAB);
	public static final RegistryObject<Item> APOPHYLLITE_TILES = block(RagemodModBlocks.APOPHYLLITE_TILES, RagemodModTabs.TAB_RAGEMOD_TAB);
	public static final RegistryObject<Item> APOPHYLLITE_TILE_STAIRS = block(RagemodModBlocks.APOPHYLLITE_TILE_STAIRS,
			RagemodModTabs.TAB_RAGEMOD_TAB);
	public static final RegistryObject<Item> APOPHYLLITE_TILE_SLAB = block(RagemodModBlocks.APOPHYLLITE_TILE_SLAB, RagemodModTabs.TAB_RAGEMOD_TAB);
	public static final RegistryObject<Item> APOPHYLLITE_TILE_WALL = block(RagemodModBlocks.APOPHYLLITE_TILE_WALL, RagemodModTabs.TAB_RAGEMOD_TAB);
