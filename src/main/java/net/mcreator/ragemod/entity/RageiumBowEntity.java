...
public class RageiumBowEntity extends AbstractArrow implements ItemSupplier {
	public RageiumBowEntity(FMLPlayMessages.SpawnEntity packet, Level world) {
		super(RagemodModEntities.RAGEIUM_BOW, world);
	}
	...
	public ItemStack getItem() {
		return new ItemStack(RagemodModItems.RAGEIUM_ARROW);
	}
	...
	public static RageiumBowEntity shoot(Level world, LivingEntity entity, Random random, float power, double damage, int knockback) {
		RageiumBowEntity entityarrow = new RageiumBowEntity(RagemodModEntities.RAGEIUM_BOW, entity, world);
	...
	public static RageiumBowEntity shoot(LivingEntity entity, LivingEntity target) {
		RageiumBowEntity entityarrow = new RageiumBowEntity(RagemodModEntities.RAGEIUM_BOW, entity, entity.level);
